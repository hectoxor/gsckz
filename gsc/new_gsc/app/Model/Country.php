...
class Country extends AppModel{
	...
	public $validate = array(
		...
		'alias' => array(
			'rule' => 'notEmpty',
			'message' => 'Введите alias (название страны на английском)'
		),
		'img' => array(
			'uploadError' => array(
				'rule' => 'uploadError',
			...
			'fileSize' => array(
				...
				'message' => 'Максимальный размер файла - 2 Мб',
				'allowEmpty' => true
			),
	...
	public function customUploadImg($file = array()){
		...
		$path = WWW_ROOT . 'img/countries/' . $fileName;
		$path_th = WWW_ROOT . 'img/countries/thumbs/' . $fileName;
		if(!move_uploaded_file($file['img']['tmp_name'], $path)){
			return false;
		}
		$this->resizeImg($path, $path_th, 354, 160, $ext);
	...
	public function genNameFile($ext){
		...
		if(is_file(WWW_ROOT . 'img/countries/' . $name)){
