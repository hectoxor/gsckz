 ...
 */
	...
	// Configure::write('Routing.prefixes', array('kz'));
 ...
 */
	Configure::write('Session', array(
		'defaults' => 'php',
		'timeout'  => 14400,
		'cookieTimeout' => 10 * 14400,
	));

/**
 * A random string used in security hashing methods.
 */
	Configure::write('Security.salt', 'DYhG93b0qyJLIxfs2guVoUubWwvniR2G0FgaC9mi');

/**
 * A random numeric string (digits only) used to encrypt/decrypt strings.
 */
	Configure::write('Security.cipherSeed', '76859309657453542496744683645');
