	...
	<ul class="navbar-nav">
		<li class="logo">
			<a href="/" class="nav-link">
				<img class="img object-fit-cover" src="/assets/logo.png " alt="Logo GSC Study" />
			</a>
		</li>
		...
		<li class="nav-right-content">
			<div class="nav-dropdown border-alpha language-select p-5" tabindex="0">
			...
			<div class="nav-contacts--mobile container gap-12 align-center">
				...
				<a class="nav-link button button-outline text-color-white" onclick="handleModalToggle('apply-modal');">
					<span class="text text-type-medium-14 text-font-weight-700 text-font-family-primary text-transform-uppercase text-overflow">Получить консультацию</span>
				</a>
			</div>
			<div id="nav-toggle-button" class="button button-ico background-primary border-alpha" onclick="handleNavToggle();">
				<span class="ico ico-24">
					<i class="ico-bars"></i>
					<i class="ico-close mix-blend-multiply"></i>
				</span>
			</div>
		</li>
	</ul>
