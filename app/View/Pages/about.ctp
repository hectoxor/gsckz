...
<section class="container--column gap-40 px-8 mx-40">
	...
	<span class="text text-type-medium-16">
		Образовательный центр GSC STUDY был открыт в 2011 году в Астане. <br><br>
	...
	<div class="container container--column-mobile">
		...
		<div class="container--column justify-center flex-1">
			...
			<span class="text text-type-medium-16">
				...
				За 12 лет работы мы решили немало сложных задач, которые возникали перед нами и нашими студентами. <br><br>
			
				Поэтому мы знаем как найти подходящие варианты университетов с максимальной вероятностью поступления, как вести переговоры с ВУЗами в спорных вопросах, а также как заново подать документы на визу, в случае отказа при первой попытке. 
				Задачей центра является не только помощь с поступлением, но и выбор наиболее комфортной среды проживания для будущего студента и помощь в составлении финансового плана для родителей. 
			</span>
		</div>
	</div>

	<span class="text text-type-medium-16">
		За все время работы более 3000 наших студентов поступили на академические программы бакалавриата, магистратуры, MBA. <br><br>
		Более 500 студентов участвовали на международных программах по изучению английского языка в Великобритании, США и Швейцарии.  <br><br>
		10 000 студентов прошли курсы английского языка на базах наших центров в Казахстане. <br><br>
		Главная цель нашего образовательного центра – помочь молодым людям сделать правильный и осознанный выбор, дать возможность каждому студенту получить качественное, аккредитованное, доступное и востребованное в мире образование. <br><br>
	</span>
</section>
