...
class HigherEducation extends AppModel{
	public $actsAs = array(
		'Translate' => array(
			'title',
			'body',
 ...
 //        ),
	...
	public function customUploadImg($file = array()){
		...
		$path = WWW_ROOT . 'img/higher_educations/' . $fileName;
		$path_th = WWW_ROOT . 'img/higher_educations/thumbs/' . $fileName;
	...
	public function genNameFile($ext){
		...
		if(is_file(WWW_ROOT . 'img/higher_educations/' . $name)){
