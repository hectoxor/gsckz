...
class SecondaryEducation extends AppModel{
	public $actsAs = array(
		'Translate' => array(
			'title',
			'body',
	...
	public $useTable = 'secondary_educations';
 ...
 //        ),
	...
	public function customUploadImg($file = array()){
		...
		$path = WWW_ROOT . 'img/mba/' . $fileName;
		$path_th = WWW_ROOT . 'img/mba/thumbs/' . $fileName;
	...
	public function genNameFile($ext){
		...
		if(is_file(WWW_ROOT . 'img/mba/' . $name)){
