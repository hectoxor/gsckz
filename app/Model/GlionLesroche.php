...
class GlionLesroche extends AppModel{
	public $actsAs = array(
		'Translate' => array(
			'title',
			'body',
	...
	public function customUploadImg($file = array()){
		...
		$path = WWW_ROOT . 'img/glion_lesroches/' . $fileName;
		$path_th = WWW_ROOT . 'img/glion_lesroches/thumbs/' . $fileName;
	...
	public function genNameFile($ext){
		...
		if(is_file(WWW_ROOT . 'img/glion_lesroches/' . $name)){
