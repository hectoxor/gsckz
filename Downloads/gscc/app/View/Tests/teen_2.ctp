			...
			<div class="test-slider teen_test_slider">
				<div class="test-part js-test-part test-part--active test-part--grammar tab-items active">
					...
					<div class="tests-row">
						<div class="test-row__inner test-row">
							<div class="question">
								<span class="question__heading">1. There … a lot of food in the fridge.</span>
								...
								<div class="question-row">
									...
									<label for="q1a3" class="question-row__text">have</label>
								</div>
								<!-- <div class="question-row">
							...
							<div class="question">
								<span class="question__heading">2. She … speak Spanish.</span>
								<div class="question-row">
									<input id="q2a1" name="q2" class="question-row__input" type="radio">
									<label for="q2a1" class="question-row__text">don’t</label>
								</div>
								<div class="question-row">
									<input id="q2a2" name="q2" class="question-row__input" type="radio">
									<label for="q2a2" class="question-row__text">doesn’t</label>
								</div>
								<div class="question-row">
									<input id="q2a3" name="q2" class="question-row__input" type="radio">
									<label for="q2a3" class="question-row__text">isn’t</label>
								</div>
								<!-- <div class="question-row">
							...
							<div class="question">
								<span class="question__heading">3. I wasn’t really … at math at school</span>
								<div class="question-row">
									<input id="q3a1" name="q3" class="question-row__input" type="radio">
									<label for="q3a1" class="question-row__text">good</label>
								</div>
								<div class="question-row">
									<input id="q3a2" name="q3" class="question-row__input" type="radio">
									<label for="q3a2" class="question-row__text">able</label>
								</div>
								<div class="question-row">
									<input id="q3a3" name="q3" class="question-row__input" type="radio">
									<label for="q3a3" class="question-row__text">keen</label>
								</div>
								<!-- <div class="question-row">
							...
							<div class="question">
								<span class="question__heading">4. We … attend the lectures every day – just on Saturdays.</span>
								<div class="question-row">
									<input id="q4a1" name="q4" class="question-row__input" type="radio">
									<label for="q4a1" class="question-row__text">have to</label>
								</div>
								<div class="question-row">
									<input id="q4a2" name="q4" class="question-row__input" type="radio">
									<label for="q4a2" class="question-row__text">couldn’t to</label>
								</div>
								<div class="question-row">
									<input id="q4a3" name="q4" class="question-row__input" type="radio">
									<label for="q4a3" class="question-row__text">don’t have to</label>
								</div>
								<!-- <div class="question-row">
							...
							<div class="question">
								<span class="question__heading">5. I can type … .</span>
								<div class="question-row">
									<input id="q5a1" name="q5" class="question-row__input" type="radio">
									<label for="q5a1" class="question-row__text">slow</label>
								</div>
								<div class="question-row">
									<input id="q5a2" name="q5" class="question-row__input" type="radio">
									<label for="q5a2" class="question-row__text">quick</label>
								</div>
								<div class="question-row">
									<input id="q5a3" name="q5" class="question-row__input" type="radio">
									<label for="q5a3" class="question-row__text">quickly</label>
								</div>
								<!-- <div class="question-row">
							...
							<div class="question">
								<span class="question__heading">6. Which animals are … , dogs or monkeys?</span>
								<div class="question-row">
									<input id="q6a1" name="q6" class="question-row__input" type="radio">
									<label for="q6a1" class="question-row__text">more intelligent</label>
								</div>
								<div class="question-row">
									<input id="q6a2" name="q6" class="question-row__input" type="radio">
									<label for="q6a2" class="question-row__text">the more intelligent</label>
								</div>
								<div class="question-row">
									<input id="q6a3" name="q6" class="question-row__input" type="radio">
									<label for="q6a3" class="question-row__text">intelligenter</label>
								</div>
								<!-- <div class="question-row">
							...
							<div class="question">
								<span class="question__heading">7. Mao Zedong … ”The little Red Book” in the 1950s.</span>
								<div class="question-row">
									<input id="q7a1" name="q7" class="question-row__input" type="radio">
									<label for="q7a1" class="question-row__text">writed</label>
								</div>
								<div class="question-row">
									<input id="q7a2" name="q7" class="question-row__input" type="radio">
									<label for="q7a2" class="question-row__text">written</label>
								</div>
								<div class="question-row">
									<input id="q7a3" name="q7" class="question-row__input" type="radio">
									<label for="q7a3" class="question-row__text">wrote</label>
								</div>
								<!-- <div class="question-row">
							...
							<div class="question">
								<span class="question__heading">8. I had a pizza and a coffee. … pizza was really tasty</span>
								<div class="question-row">
									<input id="q8a1" name="q8" class="question-row__input" type="radio">
									<label for="q8a1" class="question-row__text">a</label>
								</div>
								<div class="question-row">
									<input id="q8a2" name="q8" class="question-row__input" type="radio">
									<label for="q8a2" class="question-row__text">the</label>
								</div>
								<div class="question-row">
									<input id="q8a3" name="q8" class="question-row__input" type="radio">
									<label for="q8a3" class="question-row__text">–</label>
								</div>
								<!-- <div class="question-row">
							...
							<div class="question">
								<span class="question__heading">9. Has he … the building … ?</span>
								<div class="question-row">
									<input id="q9a1" name="q9" class="question-row__input" type="radio">
									<label for="q9a1" class="question-row__text">left/already</label>
								</div>
								<div class="question-row">
									<input id="q9a2" name="q9" class="question-row__input" type="radio">
									<label for="q9a2" class="question-row__text">leave/already</label>
								</div>
								<div class="question-row">
							...
							<div class="question">
								...
								<div class="question-row">
									...
									<label for="q10a1" class="question-row__text">did you go</label>
								</div>
								<div class="question-row">
									<input id="q10a2" name="q10" class="question-row__input" type="radio">
									<label for="q10a2" class="question-row__text">was he doing</label>
								</div>
								<div class="question-row">
									<input id="q10a3" name="q10" class="question-row__input" type="radio">
									<label for="q10a3" class="question-row__text">you were doing</label>
								</div>
								<!-- <div class="question-row">
							...
							<div class="question">
								<span class="question__heading">11. Cristiano Ronaldo … over 400 goals.</span>
								<div class="question-row">
									<input id="q11a1" name="q11" class="question-row__input" type="radio">
									<label for="q11a1" class="question-row__text">scored</label>
								</div>
								<div class="question-row">
									<input id="q11a2" name="q11" class="question-row__input" type="radio">
									<label for="q11a2" class="question-row__text">has scored</label>
								</div>
								<div class="question-row">
									<input id="q11a3" name="q11" class="question-row__input" type="radio">
									<label for="q11a3" class="question-row__text">was scored</label>
								</div>
								<!-- <div class="question-row">
							...
							<div class="question">
								<span class="question__heading">12. He would buy a car if he … rich.</span>
								<div class="question-row">
									<input id="q12a1" name="q12" class="question-row__input" type="radio">
									<label for="q12a1" class="question-row__text">became</label>
								</div>
								<div class="question-row">
									<input id="q12a2" name="q12" class="question-row__input" type="radio">
									<label for="q12a2" class="question-row__text">becomes</label>
								</div>
								<div class="question-row">
									<input id="q12a3" name="q12" class="question-row__input" type="radio">
									<label for="q12a3" class="question-row__text">would become</label>
								</div>
								<!-- <div class="question-row">
							...
							<div class="question">
								<span class="question__heading">13. By 2001 they … five silver medals</span>
								<div class="question-row">
									<input id="q13a1" name="q13" class="question-row__input" type="radio">
									<label for="q13a1" class="question-row__text">won</label>
								</div>
								<div class="question-row">
									<input id="q13a2" name="q13" class="question-row__input" type="radio">
									<label for="q13a2" class="question-row__text">were won</label>
								</div>
								<div class="question-row">
									<input id="q13a3" name="q13" class="question-row__input" type="radio">
									<label for="q13a3" class="question-row__text">had won</label>
								</div>
								<!-- <div class="question-row">
							...
							<div class="question">
								<span class="question__heading">14. The letters … every Sunday.</span>
								<div class="question-row">
									<input id="q14a1" name="q14" class="question-row__input" type="radio">
									<label for="q14a1" class="question-row__text">are delivered</label>
								</div>
								<div class="question-row">
									<input id="q14a2" name="q14" class="question-row__input" type="radio">
									<label for="q14a2" class="question-row__text">deliver</label>
								</div>
								<div class="question-row">
									<input id="q14a3" name="q14" class="question-row__input" type="radio">
									<label for="q14a3" class="question-row__text">is delivered</label>
								</div>
								<!-- <div class="question-row">
							...
							<div class="question">
								<span class="question__heading">15. Jane usually avoids … late at the parties.</span>
								<div class="question-row">
									<input id="q15a1" name="q15" class="question-row__input" type="radio">
									<label for="q15a1" class="question-row__text">to stay</label>
								</div>
								<div class="question-row">
									<input id="q15a2" name="q15" class="question-row__input" type="radio">
									<label for="q15a2" class="question-row__text">stay</label>
								</div>
								<div class="question-row">
									<input id="q15a3" name="q15" class="question-row__input" type="radio">
									<label for="q15a3" class="question-row__text">staying</label>
								</div>
							</div>
						</div>
					</div>
						...
						<div class="test-row__inner">
							<div class="questions">
								<div class="questions__row">
									...
									<textarea name="tx1_wr" class="gr-area-teen-2 write-row__textarea write-row__textarea--1 js-textarea"></textarea>
								</div>
								<div class="questions__row">
									<span class="question__heading">2. This is a place you go to if you want to catch a plane.</span>
									<textarea name="tx2_wr" class="gr-area-teen-2 write-row__textarea write-row__textarea--1 js-textarea"></textarea>
								</div>
								<div class="questions__row">
									<span class="question__heading">3. if you want to be one of these, you need to be very good at drawing or painting</span>
									<textarea name="tx3_wr" class="gr-area-teen-2 write-row__textarea write-row__textarea--1 js-textarea"></textarea>
								</div>
								<div class="questions__row">
									<span class="question__heading">4. You usually see this inside a big tent. You might see horses, lions and elephants here.</span>
									<textarea name="tx4_wr" class="gr-area-teen-2 write-row__textarea write-row__textarea--1 js-textarea"></textarea>
								</div>
								<div class="questions__row">
									<span class="question__heading">5. This is someone who works in the theatre, in films or on TV.</span>
									<textarea name="tx5_wr" class="gr-area-teen-2 write-row__textarea write-row__textarea--1 js-textarea"></textarea>
								</div>
								<div class="questions__row">
									<span class="question__heading">6. People laugh when they see this person with his round, red nose, big feet and strange clothes.</span>
									<textarea name="tx6_wr" class="gr-area-teen-2 write-row__textarea write-row__textarea--1 js-textarea"></textarea>
								</div>
								<div class="questions__row">
									<span class="question__heading">7. An ambulance might take you here if you are very ill</span>
									<textarea name="tx7_wr" class="gr-area-teen-2 write-row__textarea write-row__textarea--1 js-textarea"></textarea>
								</div>
								<div class="questions__row">
									<span class="question__heading">8. You go to this place if you want to get money or talk to someone about your money.</span>
									<textarea name="tx8_wr" class="gr-area-teen-2 write-row__textarea write-row__textarea--1 js-textarea"></textarea>
								</div>
								<div class="questions__row">
									<span class="question__heading">9. This person makes you better when you have a toothache</span>
									<textarea name="tx9_wr" class="gr-area-teen-2 write-row__textarea write-row__textarea--1 js-textarea"></textarea>
								</div>
								<div class="questions__row">
									<span class="question__heading">10. This person writes in a newspaper about things that have happened.</span>
									<textarea name="tx10_wr" class="gr-area-teen-2 write-row__textarea write-row__textarea--1 js-textarea"></textarea>
								</div>
							</div>
						</div>
					</div>
				...
				<div class="test-part js-test-part test-part--reading tab-items">
					...
					<div class="test-section">
						...
						<span>1 San Francisco</span>
						<p>
							Fisherman's Wharf is a historic marketplace on the seafront with trendy restaurants, shops and street performes. Visit Ghirardelli Ice Cream and Chocolate Shop, and Pier 39, a lively marketplace шер shops, restaurants and music. From here you can take a cruise round the Bay.
						</p>
						<span>2 Golden Gate Bridge</span>
						<p>
							Connecting San Francisco and Marin County, this is the targest suspension bridge in the world and one of the most famous Californian landmarks. As you cross the 4200-fit bridge below the famous orange towers, you'll enjay awesome views of the entire Bay Area.
						</p>
						...
						<span>7 Los Angeles</span>
						<p>
							Have you ever wanted to record yourself?
							Now you can at the fascinating Grammy Museum. You can alse learn how to dance like Michael Jackson, and find out about the links between blues and rap.
						</p>
						<span>8 Disneyland</span>
						<p>
						...
						<!-- <p>My working day starts very early. From Monday to Friday I get up at half past three and I have a shower and a cup of coﬀee. I usually leave the house at ten past four because the car always arrives a few minutes early. I get to the studio at about five o'clock and start work. My programme Good Morning Britain starts at seven o'clock and finishes at nine o'clock. Then I leave the studio at a quarter past ten. After that, I go shopping and visit some friends. I get home at three o'clock. A woman helps me with the housework and the ironing. I read a newspaper and do some work.</p>
						<p>Then my husband gets home at half past five in the evening and I cook dinner. We stay at home in the evening. We don't go out because I go to bed very early. We usually watch television and then I go to bed at half past eight, I'm usually asleep by nine o'clock.</p>
					...
					<div class="tests-row">
						<div class="test-row__inner test-row">
							...
							<div class="question">
								<span class="question__heading">1. Fisherman’s Wharf, Ghirardelli Square and Pier 39 are all in San Francisco.</span>
								<div class="question-row">
							...
							<div class="question">
								<span class="question__heading">2. The Golden Gate Bridge is the shortest suspension bridge in the world.</span>
								<div class="question-row">
							...
							<div class="question">
								<span class="question__heading">3. Alcatrazis still a prison today.</span>
								<div class="question-row">
							...
							<div class="question">
								<span class="question__heading">4. You can see a surfboard damaged in a shark attack in the museum in Santa Cruz.</span>
								<div class="question-row">
							...
							<div class="question">
								<span class="question__heading">5. Ice skating is a popula ractivity on Venice Beach.</span>
								<div class="question-row">
							...
							<div class="question">
								<span class="question__heading">6. You can meet real film stars at Madame Tussauds in Hollywood.</span>
								<div class="question-row">
							...
							<div class="question">
								<span class="question__heading">7. The Grammy Museum in Los Angelesis dedicated to music and dance.</span>
								<div class="question-row">
							...
							<div class="question">
								<span class="question__heading">8. Space Mountain is the name of one of the hotels in Disneyland.</span>
								<div class="question-row">
									<input id="r8a1" name="r8" class="question-row__input" type="radio">
									<label for="r8a1" class="question-row__text">True</label>
								</div>
								<div class="question-row">
									<input id="r8a2" name="r8" class="question-row__input" type="radio">
									<label for="r8a2" class="question-row__text">False</label>
								</div>
							</div>
						</div>
					</div>
				...
				<div class="test-part js-test-part test-part--listening tab-items">
					...
					<div class="tests-row">
						<div class="test-row__inner test-row">
							<div class="question">
								<span class="question__heading">1. Speaker A is talking about her</span>
								<!-- <select name="s1a1" id="s1" required>
									<option>Brother</option>
									<option>Childhood friend</option>
									<option>Next-door neighbour</option>
									<option>Boyfriend</option>
									<option>Best friend</option>
								</select> -->
								<div class="question-row">
									<input id="l1a1" name="l1" class="question-row__input" type="radio">
									<label for="l1a1" class="question-row__text">Brother</label>
								</div>
								<div class="question-row">
									<input id="l1a2" name="l1" class="question-row__input" type="radio">
									<label for="l1a2" class="question-row__text">Childhood friend</label>
								</div>
								<div class="question-row">
									<input id="l1a3" name="l1" class="question-row__input" type="radio">
									<label for="l1a3" class="question-row__text">Next-door neighbour</label>
								</div>
								<div class="question-row">
									<input id="l1a4" name="l1" class="question-row__input" type="radio">
									<label for="l1a4" class="question-row__text">Boyfriend</label>
								</div>
								<div class="question-row">
									<input id="l1a5" name="l1" class="question-row__input" type="radio">
									<label for="l1a5" class="question-row__text">Best friend</label>
								</div>
								<!-- <div class="question-row">
									<input id="l1a1" name="l1" class="question-row__input" type="radio">
									<label for="l1a1" class="question-row__text">True</label>
								</div>
								<div class="question-row">
									<input id="l1a2" name="l1" class="question-row__input" type="radio">
									<label for="l1a2" class="question-row__text">False</label>
								</div> -->
							</div>
							<div class="question">
								<span class="question__heading">2. Speaker B is talking about his</span>
								<!-- <select name="s2a1" id="s2" required>
									<option>Brother</option>
									<option>Childhood friend</option>
									<option>Next-door neighbour</option>
									<option>Boyfriend</option>
								...
								<div class="question-row">
									...
									<label for="l2a1" class="question-row__text">Brother</label>
								</div>
								<div class="question-row">
									<input id="l2a2" name="l2" class="question-row__input" type="radio">
									<label for="l2a2" class="question-row__text">Childhood friend</label>
								</div>
								<div class="question-row">
									<input id="l2a3" name="l2" class="question-row__input" type="radio">
									<label for="l2a3" class="question-row__text">Next-door neighbour</label>
								</div>
								<div class="question-row">
									<input id="l2a4" name="l2" class="question-row__input" type="radio">
									<label for="l2a4" class="question-row__text">Boyfriend</label>
								</div>
								<div class="question-row">
									<input id="l2a5" name="l2" class="question-row__input" type="radio">
									<label for="l2a5" class="question-row__text">Best friend</label>
								</div>
								<!-- <div class="question-row">
									<input id="l2a1" name="l2" class="question-row__input" type="radio">
									<label for="l2a1" class="question-row__text">True</label>
								</div>
								<div class="question-row">
									<input id="l2a2" name="l2" class="question-row__input" type="radio">
									<label for="l2a2" class="question-row__text">False</label>
								</div> -->
							</div>
							<div class="question">
								<span class="question__heading">3. Speaker C is talking about he</span>
								<!-- <select name="s3a1" id="s3" required>
									<option>Brother</option>
									<option>Childhood friend</option>
									<option>Next-door neighbour</option>
									<option>Boyfriend</option>
								...
								<div class="question-row">
									...
									<label for="l3a1" class="question-row__text">Brother</label>
								</div>
								<div class="question-row">
									<input id="l3a2" name="l3" class="question-row__input" type="radio">
									<label for="l3a2" class="question-row__text">Childhood friend</label>
								</div>
								<div class="question-row">
									<input id="l3a3" name="l3" class="question-row__input" type="radio">
									<label for="l3a3" class="question-row__text">Next-door neighbour</label>
								</div>
								<div class="question-row">
									<input id="l3a4" name="l3" class="question-row__input" type="radio">
									<label for="l3a4" class="question-row__text">Boyfriend</label>
								</div>
								<div class="question-row">
									<input id="l3a5" name="l3" class="question-row__input" type="radio">
									<label for="l3a5" class="question-row__text">Best friend</label>
								</div>
								<!-- <div class="question-row">
									<input id="l3a1" name="l3" class="question-row__input" type="radio">
									<label for="l3a1" class="question-row__text">True</label>
								</div>
								<div class="question-row">
									<input id="l3a2" name="l3" class="question-row__input" type="radio">
									<label for="l3a2" class="question-row__text">False</label>
								</div> -->
							</div>
							<div class="question">
								<span class="question__heading">4. Speaker D is talking about his</span>
								<!-- <select name="s4a1" id="s4" required>
									<option>Brother</option>
									<option>Childhood friend</option>
									<option>Next-door neighbour</option>
									<option>Boyfriend</option>
								...
								<div class="question-row">
									...
									<label for="l4a1" class="question-row__text">Brother</label>
								</div>
								<div class="question-row">
									<input id="l4a2" name="l4" class="question-row__input" type="radio">
									<label for="l4a2" class="question-row__text">Childhood friend</label>
								</div>
								<div class="question-row">
									<input id="l4a3" name="l4" class="question-row__input" type="radio">
									<label for="l4a3" class="question-row__text">Next-door neighbour</label>
								</div>
								<div class="question-row">
									<input id="l4a4" name="l4" class="question-row__input" type="radio">
									<label for="l4a4" class="question-row__text">Boyfriend</label>
								</div>
								<div class="question-row">
									<input id="l4a5" name="l4" class="question-row__input" type="radio">
									<label for="l4a5" class="question-row__text">Best friend</label>
								</div>
								<!-- <div class="question-row">
									<input id="l4a1" name="l4" class="question-row__input" type="radio">
							...
							<div class="question">
								<span class="question__heading">5. Speaker E is talking about her</span>
								<!-- <select name="s5a1" id="s5" required>
									<option>Brother</option>
									<option>Childhood friend</option>
									<option>Next-door neighbour</option>
									<option>Boyfriend</option>
								...
								<div class="question-row">
									...
									<label for="l5a1" class="question-row__text">Brother</label>
								</div>
								<div class="question-row">
									<input id="l5a2" name="l5" class="question-row__input" type="radio">
									<label for="l5a2" class="question-row__text">Childhood friend</label>
								</div>
								<div class="question-row">
									<input id="l5a3" name="l5" class="question-row__input" type="radio">
									<label for="l5a3" class="question-row__text">Next-door neighbour</label>
								</div>
								<div class="question-row">
									<input id="l5a4" name="l5" class="question-row__input" type="radio">
									<label for="l5a4" class="question-row__text">Boyfriend</label>
								</div>
								<div class="question-row">
									<input id="l5a5" name="l5" class="question-row__input" type="radio">
									<label for="l5a5" class="question-row__text">Best friend</label>
								</div>
								<!-- <div class="question-row">
									<input id="l5a1" name="l5" class="question-row__input" type="radio">
					...
					<div class="tests-row">
						<div class="test-row__inner test-row">
							<div class="question">
								<span class="question__heading">1. A — Her next-door neighbour also worked with her mum.</span>
								<div class="question-row">
									<input id="l6a1" name="l6" class="question-row__input" type="radio">
									<label for="l6a1" class="question-row__text">True</label>
								</div>
							...
							<div class="question">
								<span class="question__heading">2. A — Her next-door neighbour hasa healthier lifestyle now.</span>
								<div class="question-row">
									<input id="l7a1" name="l7" class="question-row__input" type="radio">
									<label for="l7a1" class="question-row__text">True</label>
								</div>
							...
							<div class="question">
								<span class="question__heading">3. B — He didn't see his brother after he wentto university</span>
								<div class="question-row">
									<input id="l8a1" name="l8" class="question-row__input" type="radio">
									<label for="l8a1" class="question-row__text">True</label>
								</div>
							...
							<div class="question">
								<span class="question__heading">4. B — He supports the same football team as his brother.</span>
								<div class="question-row">
									<input id="l9a1" name="l9" class="question-row__input" type="radio">
									<label for="l9a1" class="question-row__text">True</label>
								</div>
								<div class="question-row">
									<input id="l9a2" name="l9" class="question-row__input" type="radio">
									<label for="l9a2" class="question-row__text">False</label>
								</div>
							</div>
							<div class="question">
								<span class="question__heading">5. C — She and herfriend argued about a boy. </span>
								<div class="question-row">
									<input id="l10a1" name="l10" class="question-row__input" type="radio">
									<label for="l10a1" class="question-row__text">True</label>
								</div>
								<div class="question-row">
									<input id="l10a2" name="l10" class="question-row__input" type="radio">
									<label for="l10a2" class="question-row__text">False</label>
								</div>
							</div>
							<div class="question">
								<span class="question__heading">6. C — She is going to go to the same university as her friend. </span>
								<div class="question-row">
							...
							<div class="question">
								<span class="question__heading">7. D — He didn’t have much in commonwith his friend when they were young.</span>
								<div class="question-row">
							...
							<div class="question">
								<span class="question__heading">8. E — She didn't like the look of her boyfriend atfirst</span>
								<div class="question-row">
				...
				<div class="test-part js-test-part test-part--writing tab-items">
					...
					<div class="writing-part">
						...
						<div class="write-row">
							...
							<textarea name="tx11_wr" class="write-row__textarea write-row__textarea--1 js-textarea"></textarea>
						</div>
					</div>
