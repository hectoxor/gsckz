		...
		<div class="container">
			<nav class="page-header-nav">
				<ul>
					...
					<li class="tab-sec"><a href="javascript:;">Vocabulary</a></li>
			...
			<div class="test-slider teen_test_slider">
						...
						<div class="test-row__inner test-row">
							...
							<div class="question">
								...
								<div class="question-row">
									...
									<label for="q16a1" class="question-row__text">older</label>
								</div>
								<div class="question-row">
									<input id="q16a2" name="q16" class="question-row__input" type="radio">
									<label for="q16a2" class="question-row__text">old</label>
								</div>
								<div class="question-row">
									<input id="q16a3" name="q16" class="question-row__input" type="radio">
									<label for="q16a3" class="question-row__text">oldest</label>
								</div>
							</div>
							<div class="question">
								...
								<div class="question-row">
									...
									<label for="q17a1" class="question-row__text">the most</label>
								</div>
								<div class="question-row">
									<input id="q17a2" name="q17" class="question-row__input" type="radio">
									<label for="q17a2" class="question-row__text">the more</label>
								</div>
								<div class="question-row">
									<input id="q17a3" name="q17" class="question-row__input" type="radio">
									<label for="q17a3" class="question-row__text">more</label>
								</div>
							</div>
							<div class="question">
								...
								<div class="question-row">
									...
									<label for="q18a1" class="question-row__text">was</label>
								</div>
								<div class="question-row">
									<input id="q18a2" name="q18" class="question-row__input" type="radio">
									<label for="q18a2" class="question-row__text">were</label>
								</div>
								<div class="question-row">
									<input id="q18a3" name="q18" class="question-row__input" type="radio">
									<label for="q18a3" class="question-row__text">is</label>
								</div>
							</div>
							<div class="question">
								...
								<div class="question-row">
									...
									<label for="q19a1" class="question-row__text">keep, will</label>
								</div>
								<div class="question-row">
									<input id="q19a2" name="q19" class="question-row__input" type="radio">
									<label for="q19a2" class="question-row__text">keeps, will</label>
								</div>
								<div class="question-row">
									<input id="q19a3" name="q19" class="question-row__input" type="radio">
									<label for="q19a3" class="question-row__text">will keep, will</label>
								</div>
							</div>
							<div class="question">
								...
								<div class="question-row">
									...
									<label for="q20a1" class="question-row__text">could buy,had</label>
								</div>
								<div class="question-row">
									<input id="q20a2" name="q20" class="question-row__input" type="radio">
									<label for="q20a2" class="question-row__text">can buy, have</label>
								</div>
								<div class="question-row">
									<input id="q20a3" name="q20" class="question-row__input" type="radio">
									<label for="q20a3" class="question-row__text">could buy, have</label>
								</div>
							</div>
						</div>
					</div>
				...
				<div class="test-part js-test-part test-part--vocabulary tab-items ">
					<div class="test-area">
						<h2 class="title-sec" data-sec="grammar">Vocabulary</h2>
						...
						<div class="question">
							<span class="question__heading">8. You go to this place if you want to get money or talk to someone about you money</span>
							<select>
								<option>an actor</option>
								<option>a hospital</option>
								<option>a bank</option>
						...
						<div class="question">
							<span class="question__heading">10. This person writes in a newspaper about things that have happend.</span>
							<select>
								<option>an actor</option>
								<option>a hospital</option>
								<option>a bank</option>
