...
class LanguageCard extends AppModel{
	...
	public function customUploadImg($file = array()){
		...
		$path = WWW_ROOT . 'img/language_cards/' . $fileName;
		$path_th = WWW_ROOT . 'img/language_cards/thumbs/' . $fileName;
	...
	public function genNameFile($ext){
		...
		if(is_file(WWW_ROOT . 'img/language_cards/' . $name)){
